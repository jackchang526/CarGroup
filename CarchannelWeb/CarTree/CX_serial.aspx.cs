...
namespace BitAuto.CarChannel.CarchannelWeb.CarTree
{
    public partial class CX_serial : TreePageBase
    {
        ...
        private void GetNavbarHtml()
        {
            ...
            {
                brandHtml = string.Format(" &gt; <a href=\"http://car.bitauto.com/tree_chexing/b_{0}/\">{1}</a>", _serialEntity.BrandId, brandName);
            }
            sbNavbar.AppendFormat("    	<div><span>您当前的位置：</span><a href=\"http://www.bitauto.com/\">易车</a> &gt; <a href=\"http://car.bitauto.com/\">车型</a> &gt; <a href=\"http://car.bitauto.com/tree_chexing/mb_{0}/\">{1}</a>{2} &gt; <strong>{3}</strong></div>"
                , master.Id
                , master.Name
                , brandHtml
                , _SerialName);
        ...
        private void InitSerial()
        {
            ...
            {
                shijiaOrHuimaiche = string.Format("<span class=\"button_gray btn-qt-w\"><a href=\"{0}?tracker_u=77_cxsxcx&leads_source=p015002\" data-channelid=\"2.22.109\" target=\"_blank\">买新车</a></span>", dicHuiMaiChe[_SerialId]);
            }
        }
        /// <summary>
        /// 得到子品牌描述
...
*/
        ...
        private void MakeCarListHtmlNew()
        {
            ...
            List<string> fuelTypeListForNoSeal = tempList.Where(p => p.Oil_FuelType != "")
                                                                  .GroupBy(p => p.Oil_FuelType)
                                                                  .Select(g => g.Key).ToList();
            if (serialEntity.SaleState.Trim() == "停销")
            {
            ...
            sb.Append("<ul class=\"title-tab\">");
            sb.AppendFormat("<li class=\"current\"><a href=\"javascript:;\">在售车款</a>{0}</li>",
                noSaleYearList.Count > 0 ? "<em>|</em>" : "");
            if (noSaleYearList.Count > 0)
            {
                sb.Append("<li id=\"pop_nosale\"><a href=\"javascript:;\" class=\"pop\">停售车款<strong></strong></a>");
                sb.Append("<div id=\"pop_nosalelist\" class=\"title-popbox title-popbox-shop\" style=\"display:none;\"><ul>");
            ...
            {
                sb.Append("    <div class=\"c-list-2014\" id=\"data_tab_jq5_0\" style=\"display: block;\">");
        ...
        private string GetCarListHtml(List<CarInfoForSerialSummaryEntity> carList, int maxPv)
        {
            ...
            foreach (IGrouping<object, CarInfoForSerialSummaryEntity> info in querySale)
            {
                ...
                //if (groupIndex == 0)
                //{
                carListHtml.Add("<tr class=\"titlebg\">");
                ...
                foreach (CarInfoForSerialSummaryEntity entity in carGroupList)
                {
                    ...
                    else
                    {
                        ...
                        carListHtml.Add(string.Format("<td style=\"text-align: right\"><span><a href=\"/{0}/m{1}/baojia/\" target=\"_blank\">{2}</a></span></td>", _SerialSpell, entity.CarID, minPrice));
                    }
                    carListHtml.Add("<td>");
                    carListHtml.Add(string.Format("<div class=\"car-summary-btn-xunjia button_gray\"><a href=\"http://dealer.bitauto.com/zuidijia/nb{0}/nc{1}/?T=2&leads_source=p015006\" target=\"_blank\">询价</a></div>", _SerialId, entity.CarID));
