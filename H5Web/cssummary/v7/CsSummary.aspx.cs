...
namespace H5Web.cssummary.v7
{
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (BaseSerialEntity != null)
            {
                if (BaseSerialEntity.SaleState == "在销" || BaseSerialEntity.SaleState == "待销")
                {
                    ...
                    {
                        DefaultCarPic = string.Format("http://image.bitautoimg.com/carchannel/pic/cspic/{0}.jpg",
                            SerialId);
                        ShareImgUrl =
                            string.Format(
                                "http://image.bitautoimg.com/newsimg-100-w0-1-q80/carchannel/pic/cspic/{0}.jpg",
                                SerialId);
                    }
                }
                else
    ...
    {
        [Description("用户版")] User = 1,
        [Description("经纪人定制版")] Broker = 2,
        [Description("经销商普通定制版")] Dealer = 3,
        [Description("经销商人车店定制版")] DealerSale = 4,
        [Description("车主卡定制版")] CheZhuKa = 5,
        [Description("惠买车定制版")] HuiMaiCheGuWen = 6
    }
}