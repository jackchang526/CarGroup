...
namespace BitAuto.CarChannel.CarchannelWeb.PageMaster
{
    public partial class CarMasterPage : PageBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            dictMasterBlockHtml = _commonhtmlBLL.GetCommonHtml(masterId, CommonHtmlEnum.TypeEnum.Master, CommonHtmlEnum.TagIdEnum.MasterBrandPage);
        ...
        private void RenderIntroduction()
        {
            ...
            htmlCode.AppendLine("<div class=\"pp-story-warp\">");
            htmlCode.AppendLine("<div class=\"img-con-box\">");
            htmlCode.AppendLine("<div class=\"img-box\">");
            htmlCode.AppendLine("<img src=\"http://image.bitautoimg.com/bt/car/default/images/logo/masterbrand/png/100/m_" + masterId + "_100.png\"/>");
            htmlCode.AppendLine("</div>");
            if (!string.IsNullOrEmpty(flagShipUrl))
            {
                htmlCode.AppendLine("<div class=\"img-box-shop\">");
                htmlCode.AppendLine(string.Format("<a target=\"_blank\" href=\"{0}\">品牌旗舰店</a>", flagShipUrl));
                htmlCode.AppendLine("</div>");
            }
            htmlCode.AppendLine("</div>");

            htmlCode.AppendLine("<div class=\"txt-box\">");
            htmlCode.AppendLine(string.Format("<h3><span>{0}品牌故事</span></h3>", masterName));

            string shortIntro = commonFunction.GetShortString(brandIntro, 70);
            if (shortIntro != brandIntro)
            {
                htmlCode.AppendLine(string.Format("<p id=\"shortBrandStory\" style=\"height: 40px;\">{0}<a href=\"javascript:;\" onclick=\"BrandZhanKai();\" target=\"_self\" style=\"font-family: 宋体\">[展开+]</a></p>", shortIntro));
                htmlCode.AppendLine(string.Format("<p id=\"detailBrandStory\" style=\"height: auto;display:none;\">{0}<a href=\"javascript:;\" onclick=\"BrandShouQi();\" target=\"_self\" style=\"font-family: 宋体\">[收起-]</a></p>", brandIntro));
            }
            else
            {
                htmlCode.AppendLine(string.Format("<p id=\"pBrandStory\" style=\"height: 40px;\"><em id=\"emBrandStory\">{0}</em></p>", shortIntro));
            }
            htmlCode.AppendLine(string.Format("<h3><span>{0}车标故事</span></h3>", masterName));
            shortIntro = commonFunction.GetShortString(logoStory, 70);
            if (shortIntro != logoStory)
            {
                htmlCode.AppendLine(string.Format("<p id=\"shortLogoStory\" style=\"height: 40px;\">{0}<a href=\"javascript:;\" onclick=\"CheBiaoZhanKai();\" target=\"_self\" style=\"font-family: 宋体\">[展开+]</a></p>", shortIntro));
                htmlCode.AppendLine(string.Format("<p id=\"detailLogoStory\" style=\"height: auto;display:none;\">{0}<a href=\"javascript:;\" onclick=\"CheBiaoShouQi();\" target=\"_self\" style=\"font-family: 宋体\">[收起-]</a></p>", logoStory));
            }
            else
            {
        ...
        private void RenderNewsNew()
        {
            ...
            try
            {
                ...
                // 有最新新闻
                htmlTitle.AppendLine("<div class=\"title-con\"><div class=\"title-box\">");
                ...
                int loop = 0;
                htmlCode.AppendFormat("<div id=\"data_table_MasterNews_{0}\">", loop.ToString());
                loop++;
                htmlCode.AppendLine("<div class=\"text-list-box-b\"><div class=\"text-list-box\">");
                ...
                foreach (DataRow newsRow in newsTable.Rows)
                {
                        ...
                        while (true)
                        {
                            ...
                            if (rows.Length > 0)
                            {
                                ...
                                if (!ListForNewsTitle.Contains(newsTitle))
                                {
                                    ...
                                    if (i == 4) //分成两列
                                    {
                                        htmlCode.AppendLine("</ul><ul class=\"text-list\">");
                                    }
                                }
                                else
                                    break;
                    ...
                    if (!ListForNewsTitle.Contains(newsTitle))
                    {
                        ...
                        htmlCode.AppendFormat("<li><a href=\"{0}\" target=\"_blank\">{1}</a><span>{2}</span></li>", newsUrl, newsTitle, newsDate);
                        i++;
                        if (i == 4) //分成两列
                        {
                            htmlCode.AppendLine("</ul><ul class=\"text-list\">");
        ...
        private void RenderBrandList()
        {
            ...
            if (brandDs != null && brandDs.Tables.Count > 0)
            {
                ...
                // 有品牌
                htmlTitle.AppendLine("<div class=\"title-con\"><div class=\"title-box\"><h2>" + masterName + "-车型</h2>");
                //变态逻辑 下不为例 add 2016.09.27
                if (masterId == 2)
                {
                    htmlTitle.AppendLine("<ul id=\"car_MasterSerialList_ul\" class=\"title-tab\" style=\"width: 590px;height: 30px;overflow: hidden;\">");
                }
                else
                {
                    htmlTitle.AppendLine("<ul id=\"car_MasterSerialList_ul\" class=\"title-tab\">");
                }
                int loop = 0;
                if (brandDs.Tables.Count > 1)
                {
                    htmlTitle.AppendLine("<li class=\"current\"><a target=\"_blank\" href=\"#\">全部</a><em>|</em></li>");
                    loop = 1;
                }
                ...
                foreach (DataTable brandTable in brandDs.Tables)
                {
                    ...
                    htmlCode.AppendLine("<div class=\"carpic_list\" id=\"data_table_MasterSerialList_" + loop.ToString() + "\" style=\"" + (brandDs.Tables.Count > 1 ? "display: none;" : "") + "\">");
                    //htmlCode.AppendLine("<div class=\"zppbj\">");
                    htmlCode.AppendLine("<ul>");
                    loop++;
                    string waitSaleHtml = "";
                    string stopSaleHtml = "";
                    ...
                    foreach (DataRow row in brandTable.Rows)
                    {
                        ...
                        serialNodeCode.AppendLine("<li>");
                        serialNodeCode.AppendLine("<a href=\"" + serialUrl + "\" target=\"_blank\"><img src=\"" + imgUrl.Replace("_5.jpg", "_1.jpg") + "\" alt=\"" + csShowName + "\"  /></a>");
                        serialNodeCode.AppendLine("<div class=\"title\"><h3><a target=\"_blank\" href=\"" + serialUrl + "\">" + csShowName + "</a></h3></div>");
                        serialNodeCode.AppendLine("<div class=\"txt\">" + priceRange + "</div>");
                        serialNodeCode.AppendLine("</li>");
                ...
                if (brandDs.Tables.Count > 1)
                {
                    int startIndex = htmlTitle.ToString().LastIndexOf("<em>|</em>");
                    htmlTitle.Remove(startIndex, 10);
                    allBrandHtml = "<div id=\"data_table_MasterSerialList_0\" class=\"carpic_list\" ><ul>" + htmlAllSerial.ToString() + htmlAllnoPriceHtml.ToString() + htmlAllwaitSaleHtml.ToString() + htmlAllstopSaleHtml.ToString() + "</ul></div>";
                }
            }
        ...
        private void RenderDealerByBrand()
        {
            ...
            if (masterEntity != null && masterEntity.BrandList.Length > 0)
            {
                ...
                tabBrandHtml.Append("<div class=\"title-con\"><div class=\"title-box\">");
                tabBrandHtml.Append("	<h2>");
                tabBrandHtml.Append(string.Format("<a href=\"http://dealer.bitauto.com/{0}/\" >{1}-经销商推荐</a></h2>", masterUrlSpell, masterName));
                if (masterEntity.BrandList.Count() > 1)
                {
                    //if (masterName == "一汽")
                    //{
                    tabBrandHtml.Append("<div style=\" width: 450px; height: 50px; overflow: hidden; position: relative;\">");
                    tabBrandHtml.Append("<ul id=\"car_MasterDealer_tab_ul\" class=\"title-tab\" style=\"position: absolute;width: 800px;\">");
                    //}
                    //else
                    //{
                    //    tabBrandHtml.Append("<ul class=\"title-tab\" id=\"car_MasterDealer_tab_ul\">");
                    //}
                }


                brandListHtml.Add("<div class=\"jxs-box\"><ul class=\"jxs-list\">");
                //sb.Append("		<ul id=\"car_MasterDealer_tab_ul\" class=\"title-tab\">");
                int i = 0;
                foreach (BrandEntity brand in masterEntity.BrandList)
                {
                    ...
                    if (masterEntity.BrandList.Count() > 1)
                    {
                        tabBrandHtml.Append(
                            string.Format(
                                "<li class=\"{0}\"><a href=\"http://dealer.bitauto.com/{1}/\" target=\"_blank\">{2}</a><em>|</em></li>",
                                i == 0 ? "current" : "", brand.AllSpell, brand.ShowName));
                    }
                    brandListHtml.Add(string.Format("<div id=\"data_table_MasterDealer_{0}\" class=\"c\" style=\"display: {1};\">", i, i == 0 ? "block" : "none"));
                    //brandListHtml.Add(string.Format("<ins Id=\"ep_union_{1}\" Partner=\"1\" Version=\"\" isUpdate=\"1\" type=\"1\" city_type=\"-1\" city_id=\"0\" city_name=\"0\" car_type=\"1\" brandId=\"{0}\" serialId=\"0\" carId=\"0\"></ins>", brand.Id, (83 + i)));
                    //brandListHtml.Add(string.Format("<ins Id=\"ep_union_{1}\" Partner=\"1\" Version=\"\" isUpdate=\"1\" type=\"1\" city_type=\"-1\" city_id=\"0\" city_name=\"0\" car_type=\"1\" brandId=\"{0}\" serialId=\"0\" carId=\"0\"></ins>", brand.Id, (107 + i)));
                    brandListHtml.Add(string.Format("<script type=\"text/javascript\">document.writeln(\"<ins Id=\\\"ep_union_{1}\\\" Partner=\\\"1\\\" Version=\\\"\\\" isUpdate=\\\"1\\\" type=\\\"1\\\" city_type=\\\"1\\\" city_id=\\\"\" + bit_locationInfo.cityId + \"\\\" city_name=\\\"0\\\" car_type=\\\"1\\\" brandId=\\\"{0}\\\" serialId=\\\"0\\\" carId=\\\"0\\\"></ins>\");</script>", brand.Id, (129 + i)));
                ...
                brandListHtml.Add("		</ul></div>");
                if (masterEntity.BrandList.Count() > 1)
                {

                    int startIndex = tabBrandHtml.ToString().LastIndexOf("<em>|</em>", System.StringComparison.Ordinal);
                    tabBrandHtml.Remove(startIndex, 10);
                    tabBrandHtml.Append("</ul>");
                    //if (masterName == "一汽")
                    //{
                    tabBrandHtml.Append("</div>");
                    //}
                }
                ...
                sb.Append("	</div>");
                //sb.Append("		<script type=\"text/javascript\" src=\"http://js.bitauto.com/dealer/union/script/ads.js\"></script>");
            }
        ...
        private void RenderHotMasterBrand()
        {
            ...
            if (ds != null && ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
            {
                ...
                {
                    sb.AppendFormat("<li><a target=\"_blank\" href=\"/{0}/\"><img src=\"http://image.bitautoimg.com/bt/car/default/images/logo/masterbrand/png/55/m_{1}_55.png\" alt=\"{2}\" /></a><div class=\"title2\"><a href=\"/{0}/\" target=\"_blank\">{2}</a></div></li>", dr["urlspell"], dr["bs_Id"], dr["bs_Name"]);
                }
                sb.AppendFormat("</ul>");
            }
