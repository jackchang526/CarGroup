<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SerialForFunctionList.aspx.cs"
    Inherits="BitAuto.CarChannel.CarchannelWeb.PageList.SerialForFunctionList" %>
...
<head>
    ...
    <title>【按用途查找车型_汽车车型大全】-易车网</title>
    ...
    <%} %>
        ...
        <div id="treeFiexdNav" class="publicTabNew">
            <ul class="tab" id="ulForTempClickStat">
                ...
                <li id="Li5" class="current"><a href="/functionlist.html<%=(wt=="2345nyif"?"?WT.mc_id=2345nyif":"") %>">按用途</a></li>
            </ul>
        </div>
    ...
    <div class="bt_page">
        ...
        <div class="pinpai_box">
            <div class="pinpai_menu">
                <ul class="list9">
                    <li class=" "><a href="#yy">越野<span>|</span></a></li>
                    <li class=" "><a href="#ss">时尚<span>|</span></a></li>
                    <li class=" "><a href="#jy">家用<span>|</span></a></li>
                    <li class=" "><a href="#db">代步<span>|</span></a></li>
                    <li class=" "><a href="#xx">休闲<span>|</span></a></li>
                    <li class=" "><a href="#yd">运动<span>|</span></a></li>
                    <li class=" "><a href="#sw">商务<span>|</span></a></li>
                    <li class=" "><a href="#cr">cross<span>|</span></a></li>
                    <li class="last"><a href="#dgn">多功能</a></li>
                </ul>
            </div>
        </div>
        </div>
