<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CarMasterBrandPageNews.aspx.cs"
    Inherits="BitAuto.CarChannel.CarchannelWeb.PageMasterV2.CarMasterBrandPageNews" %>
            ...
            <div class="col-xs-4 left-box">
                <h1 class="brand-logo">
                    <a href="/<%=_MasterBrandSpell %>/">
                        <img class="logo" src="http://image.bitautoimg.com/bt/car/default/images/logo/masterbrand/png/55/m_<%=_MasterBrandId %>_55.png" alt="<%=_MasterBrandName%>汽车"></a>
                    <a href="/<%=_MasterBrandSpell %>/"><%=_MasterBrandName%></a>
                </h1>
            </div>
                ...
                <div class="container"> 
                    <div class="col-auto left secondary">
                        <ul class="list" id="ulForTempClickStat">
                            <li id="treeNav_chexing" ><a target="_self" href="http://car.bitauto.com/<%=_MasterBrandSpell%>/">首页</a></li>
                            <li id="treeNav_wenzhang" class="active"><a target="_self" href="http://car.bitauto.com/<%=_MasterBrandSpell%>/wenzhang/">文章</a></li>
                            <li id="treeNav_tupian"><a target="_blank" href="http://photo.bitauto.com/master/<%=_MasterBrandId%>/">图片</a></li>
                            <li id="treeNav_shipin"><a target="_blank" href="http://v.bitauto.com/car/master/<%=_MasterBrandId%>_0_0.html">视频</a></li>
                            <li id="treeNav_pirce"><a target="_blank" href="http://price.bitauto.com/mb<%=_MasterBrandId%>/">报价</a></li>
                            <li id="treeNav_jiangjia"><a target="_blank" href="http://jiangjia.bitauto.com/mb<%=_MasterBrandId%>/">降价</a></li>
                            <li id="treeNav_dealer"><a target="_blank" href="http://dealer.bitauto.com/<%=_MasterBrandSpell%>/">经销商</a></li>
                            <li id="treeNav_zhihuan"><a target="_blank" href="http://maiche.taoche.com/zhihuan/?master=<%=_MasterBrandId%>/">置换</a></li>
                            <li id="treeNav_yanghu"><a target="_blank" href="http://yanghu.bitauto.com/?source=1">养护</a></li>
                            <li id="treeNav_ershouche"><a target="_blank" href="http://www.taoche.com/<%=_MasterBrandSpell %>/">二手车</a></li>
                            <li id="treeNav_jinkouche"><a target="_blank" href="http://koubei.bitauto.com/tree/xuanche/?mid=<%=_MasterBrandId%>">口碑</a></li>
