<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CsSummary.aspx.cs" Inherits="H5Web.V6.CsSummary" %>
<%@ Import Namespace="H5Web.V6" %>
...
<%
    switch (CurrentCustomizationType)
    {
        case CustomizationType.User:
%>
    <script src="http://image.bitautoimg.com/carchannel/h5/js/cssummary/UserDataModule.v1.js?v=201604131602"></script>
