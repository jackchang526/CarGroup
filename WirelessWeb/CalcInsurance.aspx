<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CalcInsurance.aspx.cs" Inherits="WirelessWeb.CalcInsurance" %>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            $("#chongZhi").on("click", function () {
                ...
                //$("#luochePrice").val("");
                //$("#topLayer").show();
                //$("#startCal").attr("href", "javascript:void(0)");
                ...
                if (!carid && condition1) {
                    ...
                    if (!carid) {
                        if (isNaN(luochePrice) || !luochePrice) {
                            ...
                            $("#topLayer").hide();
                            location.href = "/qichebaoxianjisuan/?carprice=" + luochePrice;
                        }
                    } else {
                        $("#topLayer").hide();
                        ...
                        if (oldCarPrice != newCarPrice) {
                            location.href = "/qichebaoxianjisuan/?carid=" + carid + "&carprice=" + newCarPrice;
                        } else {
        ...
        function selectCarId(carId) {
            location.href = "/qichebaoxianjisuancal/?carid=" + carId;
