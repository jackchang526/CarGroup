<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CalcAutoCashTool.aspx.cs"
    Inherits="WirelessWeb.CalcAutoCashTool" %>
...
<body>
    <div class="op-nav">
        ...
        <div class="tt-name"><a href="http://m.yiche.com/" class="yiche-logo">易车</a><h1><%= serialName %></h1>
        </div>
    ...
    <div class="masterBox">
        ...
        <div id="floatLayer" class="top_layer2">
            <div class="tit">全款总价</div>
            <div class="num-box"><i id="totalPrice">0</i><span>元</span></div>
            <a id="chongZhi" data-channelid="107.107.1063" href="javascript:void(0)" class="btn-resetting">重置</a>
        ...
        <div class="qkzj_top_layer" style="display: none">
            <span class="fl">全款总价</span>
            <span class="fr"><em id="totalPriceLayer" class="num">0</em>元</span>
        </div>
        ...
        <div class="xj-form">
            <div class="xj-user-info-box jsq-user-nobg">
                <div class="xj-user-info">
                    ...
                    <strong id="gouZhiShui" class="act">0</strong>
                </div>
            </div>
        ...
        <div class="summary-box mt15">
            <div class="t-box">
                <h3>全款总价</h3>
                <span class="r-txt">
                    <label id="totalPriceBottom"></label>
                    元</span>
            </div>
    ...
    <div id="master_container" data-url="/html/selectCarTemplate.html?v=20151207" class="brandlayer mthead"></div>
    ...
    <script type="text/javascript" src="http://image.bitautoimg.com/carchannel/WirelessJs/CarCalculator.js?v=20170111"></script>
