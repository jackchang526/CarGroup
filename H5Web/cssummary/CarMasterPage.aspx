<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CarMasterPage.aspx.cs" Inherits="H5Web.cssummary.CarMasterPage" %>
...
<div class="choose-car-name-close bybrand_list">
    <div class="brand-logo-none-border m_<%= MasterId %>_b"></div>
    <span class="brand-name"><%= masterBrandEntity.Name %></span>
