<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SerialForPriceList.aspx.cs"
    Inherits="BitAuto.CarChannel.CarchannelWeb.PageList.SerialForPriceList" %>
...
<body>
    ...
    <div id="treeFiexdNav" class="publicTabNew">
        <ul class="tab" id="ulForTempClickStat">
            ...
            <li id="Li2" class="current"><a href="/price/<%=(wt=="2345nyif"?"?WT.mc_id=2345nyif":"") %>">按价格</a></li>
        ...
        <div id="theid">
            <div class="pinpai_box">
                <div class="pinpai_menu">
                    <ul class="list9">
                        <li class=" "><a href="#a">5万以下<span>|</span></a></li>
                        <li class=" "><a href="#b">5-8万<span>|</span></a></li>
                        <li class=" "><a href="#c">8-12万<span>|</span></a></li>
                        <li class=" "><a href="#d">12-18万<span>|</span></a></li>
                        <li class=" "><a href="#e">18-25万<span>|</span></a></li>
                        <li class=" "><a href="#f">25-40万<span>|</span></a></li>
                        <li class=" "><a href="#g">40-80万<span>|</span></a></li>
                        <li class=" "><a href="#h">80万以上<span>|</span></a></li>
