...
namespace BitAuto.CarChannel.CarchannelWeb.PageToolV2
{
    ...
    /// 高级选车
    /// </summary>
    public partial class SuperSelectCarToolV2 : PageBase
    {
        ...
        private void GetParameters()
        {
            ...
            {
                sortMode = "guanzhu_up";
                sortModeHtml = "<a id=\"moRen\" class= \"current up-arrow\" href=\"javascript:void(0)\">按关注</a>  <a  id=\"jiaGe\" href=\"javascript:void(0)\"class=\"up-arrow\">按价格</a>";
            }
            else if (sortMode == "2")
            {
                sortMode = "price_up";
                sortModeHtml = "<a id=\"moRen\" class= \"down-arrow\" href=\"javascript:void(0)\">按关注</a>  <a  id=\"jiaGe\" href=\"javascript:void(0)\"class=\"current up-arrow\">按价格</a>";
            }
            else if (sortMode == "3")
            {
                sortMode = "price_down";
                sortModeHtml = "<a id=\"moRen\" class= \"down-arrow\" href=\"javascript:void(0)\">按关注</a>  <a  id=\"jiaGe\" href=\"javascript:void(0)\"class=\"current down-arrow\">按价格</a>";
            }
            else
            {
                sortMode = "guanzhu_down";
                sortModeHtml = "<a id=\"moRen\" class= \"current down-arrow\" href=\"javascript:void(0)\">按关注</a>  <a  id=\"jiaGe\" href=\"javascript:void(0)\"class=\"up-arrow\">按价格</a>";
            }
