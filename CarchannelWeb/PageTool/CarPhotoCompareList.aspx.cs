	...
	public partial class CarPhotoCompareList : PageBase
	{
		...
		private void RenderContent()
		{
			...
			foreach (KeyValuePair<int, EnumCollection.SerialPhotoCompareDataNew> kvpCar in dictCarInfo)
			{
				...
				carInfoJsonList.Add(new { MasterId = kvpCar.Value.MasterId, SerialId = kvpCar.Value.CsID, CarId = kvpCar.Value.DefaultCarID });
			...
			{
				menuSideHtml = string.Format("<div class=\"left-nav left-nav-pic\" id=\"left-nav\"><ul>{0}</ul></div>", string.Concat(menuSideHtmlList.ToArray()));
			}
		...
		private void RenderNavContent()
		{
			...
			foreach (KeyValuePair<int, EnumCollection.SerialPhotoCompareDataNew> kvpCar in dictCarInfo)
			{
				...
				sb.AppendFormat("<span class=\"button_gray btn-show-car\" bit-changeindex=\"{0}\" id=\"btn-changecar-{0}\"><a href=\"javascript:;\"><b>换辆车</b></a></span>", loop);
				sb.Append("<div class=\"clear\">");
				sb.Append("</div>");
				sb.AppendFormat("<div class=\"popup-change-car\" bit-popupindex=\"{0}\" style=\"display: none;\">", loop);
				sb.Append("<div class=\"popup-change-car-box\">");
				sb.AppendFormat("<div class=\"sel-item-box\" id=\"change-master-{0}\" style=\"z-index: 50\"></div>", loop);
				sb.AppendFormat("<div class=\"sel-item-box\" id=\"change-serial-{0}\" style=\"z-index: 40\"></div>", loop);
				sb.AppendFormat("<div class=\"sel-item-box\" id=\"change-car-{0}\" style=\"z-index: 30\"></div>", loop);
				sb.Append("</div>");
				sb.AppendFormat("<div class=\"recom-car-list\" id=\"recom-car-list-{0}\"></div>", loop);
				sb.Append("</div>");
				sb.Append("</div>");
				sb.Append("</div>");
			...
			if (loop < 3)
			{
				for (int i = loop; i < 3; i++)
				{
					...
					sb.Append("<div class=\"select-box\">");
					if (i == loop)
					{
						sb.Append("<div id=\"master4\" class=\"sel-item-box\" style=\"z-index: 50\"></div>");
						sb.Append("<div id=\"serial4\" class=\"sel-item-box\" style=\"z-index: 40\"></div>");
						sb.Append("<div id=\"cartype4\" class=\"sel-item-box\" style=\"z-index: 30\"></div>");
					}
					else
					{
						sb.Append("<div class=\"sel-item-box sel-item-disabled\">");
						sb.Append("<span class=\"sel-item\"><span>请选择品牌</span><em></em></span>");
						sb.Append("</div>");
						sb.Append("<div class=\"sel-item-box sel-item-disabled\">");
						sb.Append("<span class=\"sel-item\"><span>请选择车型</span><em></em></span>");
						sb.Append("</div>");
						sb.Append("<div class=\"sel-item-box sel-item-disabled\">");
						sb.Append("<span class=\"sel-item\"><span>请选择车款</span><em></em></span>");
						sb.Append("</div>");
					}
