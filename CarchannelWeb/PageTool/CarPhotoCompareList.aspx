<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CarPhotoCompareList.aspx.cs"
    Inherits="BitAuto.CarChannel.CarchannelWeb.PageTool.CarPhotoCompareList" %>
...
<head>
    ...
    <!--#include file="~/ushtml/0000/yiche_2014_cube_tupianduibi-790.shtml"-->
...
<body data-offset="-145" data-target=".left-nav" data-spy="scroll">
    ...
    <div class="header_style">
        <div class="car_navigate">
            <div>
                ...
                <a rel="nofollow" href="/" target="_blank">车型</a> &gt; <a href="/duibi/" target="_blank">综合对比</a> &gt; <strong>图片对比</strong>
            </div>
        </div>
    ...
    <!--page start-->
    <div class="bt_page">
        <div class="publicTabNew publicTabNew-more">
            <ul class="tab">
                ...
                <li class="current"><a href="#">图片对比</a></li>
                <%--<li><a href="http://koubei.bitauto.com/duibi/<%= csIDs ==""?"":csIDs+".html" %>">口碑对比</a></li>
				<li><a href="/pingceduibi/<%= csIDs==""?"":"?csids="+csIDs+"&tagID=1" %><%= carIDs==""?"":(csIDs==""?"?carIDs="+carIDs:"&carIDs="+carIDs) %>">
					评测对比</a></li>--%>
            </ul>
    ...
    <script type="text/javascript" src="http://image.bitautoimg.com/carchannel/jsnew/dropdownlistnewV2.min.js?v=20160120"></script>
    <script type="text/javascript" src="http://image.bitautoimg.com/carchannel/jsnew/photoCompare.min.js?v=20160120"></script>
