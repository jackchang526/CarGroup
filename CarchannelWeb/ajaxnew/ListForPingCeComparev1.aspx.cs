...
{
	public partial class ListForPingCeComparev1 : PageBase
	{
		#region member
		private int type = 0;
		...
		{
			Dictionary<int, List<XmlElement>> dic = (new BitAuto.CarChannel.Common.Interface.CommonService()).GetAllSerialForPingCeCompareListNew();
				...
				&& type >= 0)
			{
				...
				if (listHot.Count > 0)
				{
					listLeft.Add("<li class=\"current\" id=\"left_0\"><a href=\"javascript:pingceCompareLeftSelect(0);\">热门车型</a></li>");
				}
				// 两厢
				if (listLaingXiang.Count > 0)
				{
					listLeft.Add("<li class=\"\" id=\"left_1\"><a href=\"javascript:pingceCompareLeftSelect(1);\">两厢</a></li>");
				}
				// 三厢
				if (listShanXiang.Count > 0)
				{
					listLeft.Add("<li class=\"\" id=\"left_2\"><a href=\"javascript:pingceCompareLeftSelect(2);\">三厢</a></li>");
				}
				// SUV
				if (listSUV.Count > 0)
				{
					listLeft.Add("<li class=\"\" id=\"left_3\"><a href=\"javascript:pingceCompareLeftSelect(3);\">SUV</a></li>");
				}
				// 其他
				if (listQiTa.Count > 0)
				{
					listLeft.Add("<li class=\"\" id=\"left_4\"><a href=\"javascript:pingceCompareLeftSelect(4);\">其它</a></li>");
				}
				listLeft.Add("</ul></dt>");
				#endregion
