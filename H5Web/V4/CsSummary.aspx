<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="~/V4/CsSummary.aspx.cs" Inherits="H5Web.V4.CsSummary" %>
<%@ Import Namespace="H5Web.V4" %>
...
<head>
    ...
    <script src="http://image.bitautoimg.com/carchannel/h5/js/Common/jquery.fullpage2.6.5.js"></script>
    <script src="http://image.bitautoimg.com/carchannel/h5/js/Common/jquery.tmpl.min.js"></script>
    ...
    <%
        switch (CurrentCustomizationType)
        {
            case CustomizationType.Broker:
    %>
        <script type="text/javascript" id="brokershare">
            $.get("/handlers/GetDataAsynV4.ashx?service=agent&method=share&csid=<%= SerialId %>&brokerid=<%= Brokerid %>&type=4", function(data) {
                $("#brokershare").html(data);
            });
        </script>
        <%
                break;
            case CustomizationType.Dealer:
        %>
        <script type="text/javascript" id="dealershare">
            $.get("/handlers/GetDataAsynV4.ashx?service=dealer&method=dealershare&dealerid=<%= Dealerid %>&csid=<%= SerialId %>&", function(data) {
                $("#dealershare").html(data);
            });
        </script>
    <%
                break;
...
%>
    ...
    <script type="text/javascript">
        /* star 换车按钮*/
        $("#changecar_f").bind("click", function() {
            var par = "";
...
%>
    ...
    <div id="scriptcontiner">
        <script type="text/javascript">
            $.get("/handlers/GetDataAsynV4.ashx?service=dealersale&method=dealersaleshare&dealerpersonid=<%= DealerPersonId %>&csid=<%= SerialId %>&", function(data) {
                $("#scriptcontiner").html(data);
            });
        </script>
    </div>
    <div class="menu">
...
<div class="section page1" data-anchor="page1">
    ...
    %>
        ...
        <div class="section-box">
            <div id="broker">
                <script type="text/javascript">
                    $.get("/handlers/GetDataAsynV4.ashx?service=agent&method=header&csid=<%= SerialId %>&brokerid=<%= Brokerid %>&type=1&", function(data) {
                        $("#broker").html(data);
                    });
                </script>
            </div>
        ...
        <div class="section-box">
            <div id="dealersale">
                <script type="text/javascript">
                    $.get("/handlers/GetDataAsynV4.ashx?service=dealersale&method=header&dealerpersonid=<%= DealerPersonId %>&", function(data) {
                        $("#dealersale").html(data);
                    });
                </script>
            </div>
            <div class="img">
        ...
        %>
        <div class="section-box">
            <div id="huimaicheguwen">
                <script type="text/javascript">
                    $.get("/handlers/GetDataAsynV4.ashx?service=huimaiche&method=header&csid=<%= SerialId %>&agentid=<%= AgentId %>&", function(data) {
                        $("#huimaicheguwen").html(data);
                    });
                </script>
            </div>
            <div class="img">
...
<%--<script type="text/javascript" src="http://image.bitautoimg.com/mergejs,s=carchannel/h5/js/cssummary/ColorModule.v2.js,carchannel/h5/js/cssummary/FullpageModule.v2.js,carchannel/h5/js/cssummary/BaseDataModule.v2.js?v=2016012515"></script>--%>

<script src="/Scripts/cssummary/ColorModule.v2.js"></script>
<script src="/Scripts/cssummary/FullpageModule.v2.js"></script>
<script src="/Scripts/cssummary/BaseDataModule.v2.js"></script>
<%
    switch (CurrentCustomizationType)
    {
        case CustomizationType.User:
%>
    <%--<script src="http://image.bitautoimg.com/carchannel/h5/js/cssummary/UserDataModule.v2.js?v=2016012015"></script>--%>
    <script src="/Scripts/cssummary/UserDataModule.v2.js"></script>
    <%
            break;
        case CustomizationType.CheZhuKa:
    %>
    <%--<script src="http://image.bitautoimg.com/carchannel/h5/js/cssummary/CheZhuKa.v2.js?v=2016010816"></script>--%>
    <script src="/Scripts/cssummary/CheZhuKa.v2.js"></script>
    <%
            break;
        case CustomizationType.Broker:
    %>
    <%--<script src="http://image.bitautoimg.com/carchannel/h5/js/cssummary/BrokerDataModule.v2.js?v=2016010816"></script>--%>
    <script src="/Scripts/cssummary/BrokerDataModule.v2.js"></script>
    <%
            break;
        case CustomizationType.Dealer:
    %>
    <%--<script src="http://image.bitautoimg.com/carchannel/h5/js/cssummary/DealerDataModule.v2.js?v=2016012215"></script>--%>
    <script src="/Scripts/cssummary/DealerDataModule.v2.js"></script>
    <%
            break;
        case CustomizationType.DealerSale:
    %>
    <%--<script src="http://image.bitautoimg.com/carchannel/h5/js/cssummary/DealerSaleDataModule.v2.js?v=2016012515"></script>--%>
    <script src="/Scripts/cssummary/DealerSaleDataModule.v2.js"></script>
    <%
            break;
        case CustomizationType.HuiMaiCheGuWen:
    %>
    <%--<script src="http://image.bitautoimg.com/carchannel/h5/js/cssummary/huimaicheguwen.v2.js?v=2016010816"></script>--%>
    <script src="/Scripts/cssummary/huimaicheguwen.v2.js"></script>
<%
            break;
    }
%>
