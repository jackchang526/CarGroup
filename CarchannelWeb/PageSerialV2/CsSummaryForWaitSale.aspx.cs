...
namespace BitAuto.CarChannel.CarchannelWeb.PageSerialV2
{
    public partial class CsSummaryForWaitSale : PageBase
    {
        ...
        protected void MakeBlockHtml()
        {
            ...
            if (dictSerialBlockHtml.ContainsKey(waitFocusNews))
                waitFocusNewsHtml = dictSerialBlockHtml[waitFocusNews];
        ...
        private void MakeBBSNewsHtml()
        {
            ...
            if (newsList.Count > 0)
            {
                ...
                foreach (XmlNode newsNode in newsList)
                {
                    ...
                    //if (loop++ == 0)
                    //{
                    //	sbBBSNews.AppendFormat("<h3><a href=\"{0}\" target=\"_blank\" title=\"{1}\">{2}</a></h3>", filePath, newsTitle, newsTitle.Length > 16 ? (newsTitle.Substring(0, 16) + "...") : newsTitle);
                    //	continue;
                    //}
                    if (++loop > 5) break;
        ...
        private void MakeCarListHtmlNew()
        {
            ...
            sb.AppendFormat("<h2>{0}车款</h2>", serialSeoName);
            ...
            if (carinfoSaleList.Count > 0)
            {
                sb.AppendFormat("<div class=\"list-table\" id=\"data_tab_jq5_{0}\">", isWaitSale ? 1 : 0);
                ...
                sb.Append("<div class=\"special-layout-14\" style=\"left: -80px;\" id=\"carCompareFilter\" data-channelid=\"2.21.807\">");
            ...
            if (isWaitSale)
            {
                sb.AppendFormat("    <div class=\"list-table\" style=\"display: {0};\" id=\"data_tab_jq5_0\">",
        ...
        protected void MakeSerialSparkleHtml()
        {
            ...
            if (list != null && list.Count > 0)
            {
                ...
                sb.AppendFormat("<li><a data-channelid=\"2.21.1600\" href=\"/{0}/peizhi/\" target=\"_blank\">更多参数配置>></a></li>", serialSpell);
                sb.Append("</ul>");
                sb.Append("</div>");
        ...
        private string GetCarListHtml(List<CarInfoForSerialSummaryEntity> carList, int maxPv)
        {
            ...
            foreach (IGrouping<object, CarInfoForSerialSummaryEntity> info in listGroupNew)
            {
                ...
                foreach (CarInfoForSerialSummaryEntity entity in carGroupList)
                {
                    ...
                    carListHtml.Add(string.Format("<a class=\"btn btn-primary btn-xs\" data-channelid=\"2.21.849\" href=\"http://dealer.bitauto.com/zuidijia/nb{0}/nc{1}/?T=2&leads_source=p002011\" target=\"_blank\">询底价</a> "
                        , serialId
                        , entity.CarID));
                    //carListHtml.Add(string.Format("<a class=\"btn btn-xs\" data-channelid=\"2.21.1342\" href=\"http://item.huimaiche.com/{0}/{1}/?tracker_u=612_ckzs\" target=\"_blank\">买车</a>"
                    //	, serialSpell
                    //	, entity.CarID));
                    carListHtml.Add(string.Format("<a class=\"btn btn-secondary btn-xs\" data-use=\"compare\" href=\"javascript:;\" data-id=\"{0}\" data-channelid=\"2.21.850\"><span>+对比</span></a>", entity.CarID));
                    carListHtml.Add("</td>");
                    carListHtml.Add("</tr>");
                }
            }
            ...
            //{
            //    if (kv.Value) mpSerialYouHuiHtml += string.Format("<span class=\"lower-tax\">{0}</span>", kv.Key);
            //}
        ...
        private void MakeFocusImages()
        {
            ...
            {
                //白底封面图
                string serialWhiteImageUrl = Car_SerialBll.GetSerialImageUrl(serialId, "6");
                bigImage.Insert(0, string.Format("{2}<div id=\"focus_image_first\" style=\"display:block\"><a href=\"http://photo.bitauto.com/serial/{1}/\" target=\"_blank\"><img src=\"{0}\" alt=\"\" /></a></div>",
                    serialWhiteImageUrl,
                    serialId,
                     picCount > 0 ? string.Format("<a target=\"_blank\" href=\"{1}\" class=\"img-link\">共{0}张图片&gt;&gt;</a>",
                                    picCount,
            ...
            for (int i = imgList.Count - 1; i >= 1; i--)
            {
                ...
                if (i == 1 && true)
                {
                    ...
                    if (firstTujieNode != null)
                    {
                        ...
                        sb.AppendFormat("<div data-channelid=\"2.21.796\" class=\"img-link col-auto\"><a href=\"{0}\" target=\"_blank\">{3}<img src=\"{1}\" title=\"{2}\" alt=\"{2}\" width=\"140\" height=\"93\" /></a></div>",
                ...
                sb.AppendFormat("<div data-channelid=\"2.21.795\" class=\"img-link col-auto\"><a href=\"{0}\" target=\"_blank\">{3}<img src=\"{1}\" title=\"{2}\" alt=\"{2}\" width=\"140\" height=\"93\" /></a></div>",
                    csImg.TargetUrl,
                    smallImgUrl,
                    csImg.ImageName,
            ...
            if (videoList.Count > 0)
            {
                ...
                sb.AppendFormat("<div data-channelid=\"2.21.797\" class=\"img-link img-current col-auto\"><a href=\"{0}\" target=\"_blank\"><i>视频</i><em></em><img src=\"{1}\" title=\"{2}\" alt=\"{2}\" width=\"140\" height=\"93\" /></a></div>",
                ...
                if (dsCsPic != null && dsCsPic.Tables.Count > 0 && dsCsPic.Tables.Contains("A"))
                {
                    if (dsCsPic.Tables.Contains("C") && dsCsPic.Tables["C"].Rows.Count > 0)
                    {
                        ...
                        foreach (DataRow row in dsCsPic.Tables["C"].Select("P='8'"))//空间
                        {
                            ...
                            sb.AppendFormat("<div data-channelid=\"2.21.797\" class=\"img-link img-current col-auto\"><a href=\"{0}\" target=\"_blank\"><i>{2}</i><img src=\"{1}\" title=\"{2}\" alt=\"{2}\" width=\"140\" height=\"93\" /></a></div>", picUlr, imgUrl, "空间");
                            break;
                        }
                        ...
                        if (speceImageCount <= 0)
                        {
                            foreach (DataRow row in dsCsPic.Tables["C"].Rows)//空间
                            {
                                ...
                                string picName = Convert.ToString(row["D"]);
                                string picUlr = "http://photo.bitauto.com/picture/" + serialId + "/" + imgId + "/";
                                sb.AppendFormat("<div data-channelid=\"2.21.797\" class=\"img-link img-current col-auto\"><a href=\"{0}\" target=\"_blank\"><img src=\"{1}\" title=\"{2}\" alt=\"{2}\" width=\"140\" height=\"93\" /></a></div>", picUlr, imgUrl, serialShowName + "图片");
                                break;
                            }
                        }
                    }
