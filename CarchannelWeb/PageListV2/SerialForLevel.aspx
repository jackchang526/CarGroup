<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SerialForLevel.aspx.cs"
    Inherits="BitAuto.CarChannel.CarchannelWeb.PageListV2.SerialForLevel" %>
            ...
            <div class="container">
                <div class="col-auto left secondary">
                    <ul class="list">
                        ...
                        <li id="accordLevel" class="active"><a href="/levellist.html<%=(wt=="2345nyif"?"?WT.mc_id=2345nyif":"") %>">按级别</a></li>
        ...
        <div style="width: 100%; height: 45px; overflow: hidden;">
            <div id="theid">
                <ul class="list list-gapline sm a-z type-1">
                    <li class=" "><a href="#a">微型车</a></li>
                    <li class=" "><a href="#b">小型车</a></li>
                    <li class=" "><a href="#c">紧凑型车</a></li>
                    <li class=" "><a href="#d">中型车</a></li>
                    <li class=" "><a href="#e">中大型车</a></li>
                    <li class=" "><a href="#f">豪华车</a></li>
                    <li class=" "><a href="#g">MPV</a></li>
                    <li class=" "><a href="#h">SUV</a></li>
                    <li class=" "><a href="#i">跑车</a></li>
                    <li class=" "><a href="#l">面包车</a></li>
