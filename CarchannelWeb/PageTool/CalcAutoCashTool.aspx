<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CalcAutoCashTool.aspx.cs"
    Inherits="BitAuto.CarChannel.CarchannelWeb.PageTool.CalcAutoCashTool" %>
...
<body onload="ResetToDefault();">
    ...
    <div class="bt_page">
        ...
        <div class="bt_pageBox">
            <div class="col-ad">
                <ins id="div_f63a792d-c99e-4257-82d7-940a693efaac" type="ad_play" adplay_ip="" adplay_areaname=""
                    adplay_cityname="" adplay_brandid="" adplay_brandname="" adplay_brandtype=""
                    adplay_blockcode="f63a792d-c99e-4257-82d7-940a693efaac"></ins>
            </div>
            <div class="header_style">
                ...
                <div id="divSerialSummaryMianBaoAD" class="top_ad02">
                    <ins id="div_b58abe55-ffcb-4540-be69-f707af5dcf43" type="ad_play" adplay_ip="" adplay_areaname="" adplay_cityname="" adplay_brandid="" adplay_brandname="" adplay_brandtype="" adplay_blockcode="b58abe55-ffcb-4540-be69-f707af5dcf43"></ins>
                </div>
            </div>
            <div class="publicTabNew">
                <ul id="calcTools" class="tab">
                    <li id="xinche_index" class="current"><a href="/gouchejisuanqi/">全款</a></li>
        ...
        <div class="line-box">
            ...
            <div class="jisuanqi_box">
                <ul class="rela_ul">
                    ...
                    <li id="liDispaly2" class="bg" style="display: none; background: #f7f7f7;">
                        <div class="l-box w360">
                            <p class="fonts2">
                                全款购车价：<em class="red16"><label id="lblTopTotal"></label>元</em>
                            </p>
                            <p class="suomin">
                                首付<label id="lblShouFu"></label>元，月供<label id="lblYueGong"></label>元 <a id="loanBuyCar"
                                    target="_blank" href="/qichedaikuanjisuanqi/">贷款购车&gt;&gt;</a>
                            </p>
                        </div>
                        <div class="clear">
                        </div>
                ...
                <table id="calEssentialCost" width="100%" cellspacing="0" cellpadding="0" border="0">
                    ...
                    <tbody>
                            ...
                            <td class="r_align">
                                <div class="jiage">
                                    <input maxlength="4" id="txtChePai" class="f-w100 f-curr" type="text" value="500"
                                        onkeyup="value=value.replace(/(\D)/g,'');calcAutoCashAll();"
                                        onfocus="if (value =='0'){value ='';}" onblur="if (value ==''){value='0';}calcAutoCashAll();" />
                                    元
                                </div>
                            </td>
                            <td>&nbsp;
                        ...
                        <tr>
                            ...
                            <td class="r_align">
                                <div class="jiage">
                                    <input id="txtVehicleTax" class="f-w100 f-curr" type="text" maxlength="4" onkeyup="value=value.replace(/(\D)/g,'');calcAutoCashAll();"
                                        onfocus="if (value =='0'){value ='';}"
                                        onblur="if (value ==''){value='0';}calcAutoCashAll();" />
                                    元
                                </div>
                            </td>
                            <td id="divCashVehicleAndVesselTaxMessage"></td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <select id="selCompulsory" class="f-w150 f-curr" onchange="calcAutoCashAll();">
            ...
            <div id="bottomSummary" class="summary-box">
                <div class="all-smmary">
                    全款购车价：<em><label id="lblBottomTotal"></label>
                        元</em>
                </div>
    ...
    <script type="text/javascript">
        $("#feedbackDiv").before("<li class=\"w4 d11-backtop\"><a href=\"http://survey01.sojump.com/jq/7446169.aspx\"  title=\"\" target=\"_blank\">问卷调查</a></li>");
