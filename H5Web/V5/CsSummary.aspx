<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CsSummary.aspx.cs" Inherits="H5Web.V5.CsSummary" %>
<%@ Import Namespace="H5Web.V5" %>
...
<head>
    ...
    %>
        <script type="text/javascript" src="/javascript/require/require.js" data-main="/javascript/main"></script>
    ...
    <script type="text/javascript">
        var Config = {
            ...
            isAd: -1, //ad=0 去掉广告
            customizationList: [<%= (int) H5Web.V3.CustomizationType.User %>], //定制列表，暂时支持用户版
