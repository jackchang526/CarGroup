<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SerialForCharList.aspx.cs"
    Inherits="BitAuto.CarChannel.CarchannelWeb.PageListV2.SerialForCharList" %>
...
<head>
    ...
    <title>【按字母查找车型_汽车车型大全】-易车网</title>
            ...
            <div class="container">
                <div class="col-auto left secondary">
                    <ul class="list">
                        ...
                        <li id="accordStyle" class="active"><a href="/charlist.html<%=(wt=="2345nyif"?"?WT.mc_id=2345nyif":"") %>">按车型</a></li>
