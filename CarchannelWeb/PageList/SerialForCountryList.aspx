<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SerialForCountryList.aspx.cs"
    Inherits="BitAuto.CarChannel.CarchannelWeb.PageList.SerialForCountryList" %>
...
<body>
    ...
    <script type="text/javascript">
        $(".bit_top990,.header_style,.nav_small,.bt_login_box990").hide();
    </script>
    <%} %>
        <!--主导航-->
        <div id="treeFiexdNav" class="publicTabNew">
            <ul class="tab" id="ulForTempClickStat">
                ...
                <li id="Li3"><a href="/levellist.html<%=(wt=="2345nyif"?"?WT.mc_id=2345nyif":"") %>">按级别</a></li>
                <li id="Li4" class="current"><a href="/countrylist.html<%=(wt=="2345nyif"?"?WT.mc_id=2345nyif":"") %>">按国别</a></li>
    ...
    <div class="bt_page">
        ...
        <div class="pinpai_box">
            <div class="pinpai_menu">
                <ul class="list9">
                    <li class=" "><a href="#zz">自主<span>|</span></a></li>
                    <li class=" "><a href="#dx">德国<span>|</span></a></li>
                    <li class=" "><a href="#rx">日本<span>|</span></a></li>
                    <li class=" "><a href="#mx">美国<span>|</span></a></li>
                    <li class=" "><a href="#hx">韩国<span>|</span></a></li>
                    <li class=" "><a href="#fx">法国<span>|</span></a></li>
                    <li class=" "><a href="#yx">英国<span>|</span></a></li>
                    <li class=" "><a href="#yx2">意大利<span>|</span></a></li>
                    <li class="last "><a href="#other">其他</a></li>
                </ul>
            </div>
        </div>
        </div>
        </div>
        <asp:Literal ID="lrContent" runat="Server" EnableViewState="false" />
        <!-- 调用尾 -->
