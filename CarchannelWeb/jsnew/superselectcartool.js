...
var SuperSelectCarTool = {
    ...
    , initPageCondition: function () {
        ...
        //确定左侧菜单位置
        $("#left-nav").css({ left: $("#box").offset().left - 92 + "px" });
    ...
    , bindFilterClickEvent: function () {
        ...
        $("#moRen").on("click", function () {
            ...
            if (jiaGeClass == "downarrow" || jiaGeClass == "current-downarrow") {
                sort = 1;
            } else {
                sort = 4;
            }
        ...
        $("#jiaGe").on("click", function () {
            var jiaGeClass = $(this).attr("class");
            if (jiaGeClass == "uparrow" || jiaGeClass == "current-downarrow") {
                sort = 2;
            } else {
                sort = 3;
            }
    ...
    , filterClickEvent: function () {
        ...
        if (element) {
            ...
            switch (conType) {
                ...
                case "more":
                    //进气形式 单选+多选
                    if ((conStr > 99 && conStr < 102) || conStr == 0) {
                        if (element.checked) {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (getElementById("styleTotal")) {
                if (styleCount > 0) {
                    $("#styleTotal").html("<p>为你找到<em>" + styleCount + "</em>个车型,<em>" + carCount + "</em>个车款</p><a href=\"/gaojixuanche/\" class=\"delall\">清空条件</a>");
                }
                else {
...
function DrawUlContent(json) {
    ...
    if (json.Count > 0 && !initFlag) {
        $("#styleTotal").html("<p>为你找到<em>" + json.Count + "</em>个车型,<em>" + json.CarNumber + "</em>个车款</p><a href=\"/gaojixuanche/\" class=\"delall\">清空条件</a>");
    }
    ...
    if (json.ResList.length == "0") {
        ...
        $(json.ResList).each(function (index) {
            ...
            divContentArray.push("<div class=\"seach_more\" bit-seachmore><a href=\"javascript:;\" bit-serial=\"" + json.ResList[index].SerialId + "\" bit-car=\"" + json.ResList[index].CarIdList + "\" bit-line=\"" + (currentLineCount - 1) + "\" bit-allspell=\"" + json.ResList[index].AllSpell + "\" class=\"sub-color\">" + json.ResList[index].CarNum + "个车款符合条件</a></div>");
            divContentArray.push("</li>");
        ...
        if (json.ResList.length > 0 && json.ResList.length % 5 != 0) {
            divContentArray.push("<li class=\"c-list-2014 c-list-2014-pop\"  bit-line=\"" + currentLineCount + "\"></li>");
        }
        divContentArray.push("</ul>");
            ...
            $targets = this.$body
                ...
                .map(function (i, n) {
                    ...
                    if ($targetElement
                        ...
                        var ElementScrollTop = ($targetElement.offset().top - ($("#topfixed").height() - 10));//10px margintop值
                        ...
                        $el.bind("click", function (e) {
                            e.preventDefault();
                            $("html,body").animate({ scrollTop: $targetElement.offset().top - $("#topfixed").height() + 10 + 1 }, 300, function () {
        ...
        if (carSynData[serialId]) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    content.push("<th width=\"18%\"><div class=\"wenh\" onmouseover=\"javascript:$(this).children('.tc-wenh').show();return false;\" onmouseout=\"javascript:$(this).children('.tc-wenh').hide();return false;\"><div class=\"tc tc-wenh\" style=\"display:none;\"><div class=\"tc-box\"><i></i><p>全国参考最低价</p></div></div></div></th></th>");
                    content.push("</tr>");
                    $.each(data.CarList, function (i, n) {
                        ...
                        content.push("<div class=\"car-summary-btn-xunjia button_gray\"><a href=\"http://dealer.bitauto.com/zuidijia/nb" + serialId + "/nc" + n.CarID + "/\" target=\"_blank\">询价</a></div>");
                        content.push("<div class=\"car-summary-btn-duibi button_gray\" id=\"carcompare_btn_new_" + n.CarID + "\"><a target=\"_self\" href=\"javascript:;\" cid=\"" + n.CarID + "\"><span>对比</span></a></div>");
                        content.push("</td>");
                        content.push("</tr>");
                    });
                    content.push("</tbody>");
