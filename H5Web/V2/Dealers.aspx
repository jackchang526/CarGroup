<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Dealers.aspx.cs" Inherits="H5Web.V2.Dealers" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head>
	<title>【<%= BaseSerialEntity.SeoName %>】经销商-易车</title>
	<meta charset="utf-8" />
...
<body>
	<div class="context_scroll" data-name="forum">
		<div class="context_scroll_box">
			
			<script type="text/javascript">
				//经销商接口：车型地图页
				document.write(unescape("%3Cscript src='/handlers/GetDateAsync.ashx?service=dealer&method=dealerimgmap&cityid=<%= CityId %>&csid=<%= SerialId %>' type='text/javascript'%3E%3C/script%3E"));
			</script>
