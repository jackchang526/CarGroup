var WaitCompareObj = {
	...
	Initanimatebottom: function () {
		var obj = this;
		$("#" + obj.PageDivID).attr("animatebottom", $(window).height() - $("#sideSkNews").offset().top - parseInt($("#sideSkNews").css("height").substr(0, $("#sideSkNews").css("height").length - 2) / 2) + $(document).scrollTop());
	},
