<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CalcAutoLoan.aspx.cs" Inherits="WirelessWeb.CalcAutoLoan" %>
   ...
   <div class="masterBox">
        ...
        <div class="min-height">
            <div class="first-tags">
                <ul>
                    <li><a id="quankuanUrl" href="/gouchejisuanqical/"><span>全款计算</span></a></li>
            ...
            <div class="m_height">
                ...
                <span>贷款利率</span>
                <input id="yearRate" type="number" class="current">
    ...
    <script type="text/javascript">
                ...
                if (!carid && condition1) {
                    ...
                    if (!carid) {
                        if (isNaN(luochePrice) || !luochePrice) {
                            ...
                            $("#topLayer").hide();
                            location.href = GetStartCalUrl("carprice", luochePrice);
                        }
                    } else {

                        location.href = GetStartCalUrl("carid", carid);
                    }
                }
            });
            $("#chongZhi").on("click", function () {
                location.href = "/qichedaikuanjisuanqical/";
            });
        ...
        function GetStartCalUrl(caridOrPrice, paraValue) {
            var startCalUrl = [];
            if (caridOrPrice == "carid") {
                var newCarPrice = GetIntValue($("#luochePrice").val());
                if (oldCarPrice != newCarPrice) {
                    startCalUrl.push("/qichedaikuanjisuanqi/?carid=" + paraValue + "&carprice=" + newCarPrice);
                } else {
                    startCalUrl.push("/qichedaikuanjisuanqi/?carid=" + paraValue);
                }
            } else {
                startCalUrl.push("/qichedaikuanjisuanqi/?carprice=" + paraValue);
            }
