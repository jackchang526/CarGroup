        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.EvaluationId > 0) {
                    ...
                    htmlArr.push("        <a data-channelid='2.21.2152' target='_blank' href='http://pingce.bitauto.com/details/" + data.EvaluationId + "-2.html'>");
                    ...
                    htmlArr.push("        <h3><a data-channelid='2.21.2153' target='_blank' href='http://pingce.bitauto.com/details/" + data.EvaluationId + "-2.html'>" + unescape(data.CarName.replace(/\\/g, "%")) + "</a></h3>");
                    htmlArr.push("        <div class='info'><span class='view'> </span><span class='comment'> </span>");
                    htmlArr.push("        </div>");
                    htmlArr.push("        <ul class='list list-gapline sm'>");
                    htmlArr.push("            <li>");
                    htmlArr.push("                <a data-channelid='2.21.2154' target='_blank' href='http://pingce.bitauto.com/details/" + data.EvaluationId + "-2.html'>空间 " + data.BodyAndSpaceGroupScore + "分</a>");
                    htmlArr.push("            </li>");
                    htmlArr.push("            <li>");
                    htmlArr.push("                <a data-channelid='2.21.2155' target='_blank' href='http://pingce.bitauto.com/details/" + data.EvaluationId + "-4.html'>舒适 " + data.RidingComfortGroupScore + "分</a>");
                    htmlArr.push("            </li>");
                    htmlArr.push("            <li>");
                    htmlArr.push("                <a data-channelid='2.21.2156' target='_blank' href='http://pingce.bitauto.com/details/" + data.EvaluationId + "-5.html'>动力 " + data.DynamicPerformanceGroupScore + "分</a>");
                    htmlArr.push("            </li>");
                    htmlArr.push("            <li>");
                    htmlArr.push("                <a data-channelid='2.21.2157' target='_blank' href='http://pingce.bitauto.com/details/" + data.EvaluationId + "-6.html'>驾驶 " + data.JsBaseGroupScore + "分</a>");
                    htmlArr.push("            </li>");
                    htmlArr.push("            <li>");
                    htmlArr.push("                <a data-channelid='2.21.2158' target='_blank' href='http://pingce.bitauto.com/details/" + data.EvaluationId + "-3.html'>安全 " + data.SafetyGroupScore + "分</a>");
                    htmlArr.push("            </li>");
                    htmlArr.push("            <li>");
                    htmlArr.push("                <a data-channelid='2.21.2159' target='_blank' href='http://pingce.bitauto.com/details/" + data.EvaluationId + "-7.html'>油耗 " + data.YhBaseGroupScore + "分</a>");
                    htmlArr.push("            </li>");
                    htmlArr.push("            <li>");
                    htmlArr.push("                <a data-channelid='2.21.2160' target='_blank' href='http://pingce.bitauto.com/details/" + data.EvaluationId + "-8.html'>费用 " + data.CostBaseGroupScore + "分</a>");
                    htmlArr.push("            </li>");
                    htmlArr.push("            <li>");
                    htmlArr.push("                <a data-channelid='2.21.2161' target='_blank' href='http://pingce.bitauto.com/details/" + data.EvaluationId + "-2.html'>更多&gt;&gt;</a>");
                    htmlArr.push("            </li>");
                    htmlArr.push("        </ul>");
                    htmlArr.push("        <div class='bottom'>");
                    htmlArr.push("            易车出品");
