<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CsCompare.aspx.cs" Inherits="BitAuto.CarChannel.CarchannelWeb.PageSerial.CsCompare" %>
...
<head>
	...
	<style type="text/css">
		.line_box_compare .y2015 table th.threeLines { height: 70px; }
	</style>
</head>
<body data-offset="-130" data-target=".left-nav" data-spy="scroll">
	...
	<div class="bt_page" id="box">
	 ...
	 { %>
		...
		<script type="text/javascript" language="javascript" src="http://image.bitautoimg.com/carchannel/jsnew/CarChannelBaikeJson.js?v=20150831"></script>
        ...
        <%--<script type="text/javascript" src="/jsnew/JsForParameterv3.0.js?v=2016031513"></script>--%>
		<script type="text/javascript">
			<%= JsTagForYear %>
   ...
   { %>
	...
	<script type="text/javascript">
		...
		setTimeout(function () {
		    //$("#side-compare").after("<li class=\"w4 d11-backtop\"><a href=\"http://survey01.sojump.com/jq/7432134.aspx\"  title=\"\" target=\"_blank\">问卷调查</a></li>");
		    WaitCompareObj.Initanimatebottom();//如果删除问卷调查，这个方法可以直接删除
		}, 1000);
    </script>
	<!--信息提示start-->
	<div class="alert-center" style="display: none; z-index: 99999;" id="alert-center">
		<p>最多对比10个车款</p>
	</div>
	<!--信息提示end-->
</body>
...
<!-- 用户行为统计 -->
<script type="text/javascript" language="javascript" src="http://image.bitautoimg.com/carchannel/jsStat/StatisticJs.js"></script>
