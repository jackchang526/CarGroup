<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SerialForCountryList.aspx.cs"
    Inherits="BitAuto.CarChannel.CarchannelWeb.PageListV2.SerialForCountryList" %>
            ...
            <div class="container">
                <div class="col-auto left secondary">
                    <ul class="list">
                        ...
                        <li id="accordCountry" class="active"><a href="/countrylist.html<%=(wt=="2345nyif"?"?WT.mc_id=2345nyif":"") %>">按国别</a></li>
        ...
        <div style="width: 100%; height: 45px; overflow: hidden;">
            <div id="theid">
                <ul class="list list-gapline sm a-z type-1">
                    <li class=" "><a href="#zz">自主</a></li>
                    <li class=" "><a href="#dx">德国</a></li>
                    <li class=" "><a href="#rx">日本</a></li>
                    <li class=" "><a href="#mx">美国</a></li>
                    <li class=" "><a href="#hx">韩国</a></li>
                    <li class=" "><a href="#fx">法国</a></li>
                    <li class=" "><a href="#yx">英国</a></li>
                    <li class=" "><a href="#yx2">意大利</a></li>
