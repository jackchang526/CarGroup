...
$(function () {
        ...
        $body.trigger('publicswipe1', {
            ...
            dataCallBack: function (paras) {
                ...
                if (options.model_hide) {
                    ...
                    /*一级车款*/
                    $body.trigger('rightswipe1', { $carSwipeLeft: $swipeLeft, $masterobj: paras.$current, masterselect: options.masterselect, carselect: options.carselect });
                }
            },
    ...
    //城市二级连选
    $body.on('region', function (ev, paras) {
        var setting = {
            controlName1: 'publicswipe1',
            controlName2: 'publicswipe1',
