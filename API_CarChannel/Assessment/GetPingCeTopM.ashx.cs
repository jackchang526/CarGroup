...
namespace BitAuto.CarChannelAPI.Web.Assessment
{
    ...
    public class GetPingCeTopM : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            paraList.Add("Score");
            paraList.Add("CommonInfoGroup.CommonInformationEntity.Title");
            paraList.Add("CommonInfoGroup.CommonInformationEntity.ImageUrl");
            ...
            paraList.Add("GeneralBaseGroupl.Score");
