<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CsSummary.aspx.cs" Inherits="H5Web.cssummary.v6.CsSummary" %>
<%@ Import Namespace="H5Web.cssummary.v6" %>
...
<!--/template-->
<script type="text/javascript" src="http://image.bitautoimg.com/mergejs,s=carchannel/h5/js/cssummary/ColorModule.v6.js,carchannel/h5/js/cssummary/FullpageModule.v6.js,carchannel/h5/js/cssummary/BaseDataModule.v1.js?v=201604011615"></script>

<%--<script src="/Scripts/cssummary/ColorModule.v6.js"></script>
<script src="/Scripts/cssummary/FullpageModule.v6.js"></script>
...
<%
    switch (CurrentCustomizationType)
    {
        case CustomizationType.User:
%>
    <script src="http://image.bitautoimg.com/carchannel/h5/js/cssummary/UserDataModule.v1.js?v=201604011615"></script>
