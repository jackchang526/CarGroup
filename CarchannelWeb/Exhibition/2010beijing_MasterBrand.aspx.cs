...
{
	public partial class _2010beijing_MasterBrand : beijing_2010_PageBase
	{
		...
		protected string BuilderPageGuilder()
		{
			...
			guilderString.AppendFormat("<em>&gt;</em><span><a href=\"{0}/\">{1}馆</a></span>"
		...
		protected string PageTitle()
		{
			...
			masterBrandTitle.AppendFormat("<img src=\"{0}\">", "http://img1.bitauto.com/bt/car/default/images/carimage/m_"
																+ _MasterBrandXmlNode.GetAttribute("ID") + "_a.png");
		...
		protected string PageNewSpan()
		{
			...
			int index = 0;
			Dictionary<string, ExhibitionNew> eNewList = GetExhibitionNewsList("master", ConvertHelper.GetInteger(_MasterBrandXmlNode.GetAttribute("ID")));
			...
			string spath = WebConfig.DataBlockPath + "Data\\CarShow\\2010Beijing\\Masterbrand\\Carshow_Masterbrand_"
					 + _MasterBrandXmlNode.GetAttribute("ID") + ".xml";
			//如果指定列表
			if (index > 0)
			{
		...
		protected string ContainsSerialList()
		{
			...
			serialString.Append("<div class=\"line_box ka_brand\">");
			...
			//主品牌Logo
			serialString.AppendFormat("<div class=\"brand\"><img src=\"{1}\"></div><div class=\"names\">{0}</div>"
										, _MasterBrandXmlNode.GetAttribute("Name")
										, "http://img1.bitauto.com/bt/car/default/images/carimage/m_"
										+ _MasterBrandXmlNode.GetAttribute("ID") + "_b.jpg");
		...
		protected string OtherMasterBrand()
		{
			...
			otherMasterBrand.AppendFormat("<h3><span><a target=\"_blank\" href=\"{1}/\">{0}馆其他厂家</a></span></h3>"
										, pavilionName
			...
			if (xNodeList != null && xNodeList.Count > 0)
			{
				...
				foreach (XmlElement xElem in xNodeList)
				{
					...
					otherMasterBrand.AppendFormat("<li><a target=\"_blank\" href=\"{1}\"><img src=\"{2}\"></a><p><a target=\"_blank\" href=\"{1}\">{0}</a></p></li>"
												 ...
												 , "http://chezhan.bitauto.com/beijing/2010/" + xElem.GetAttribute("AllSpell") + "/"
