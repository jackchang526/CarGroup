...
namespace H5Web.V6
{
    public partial class CarCompare : H5PageBase
    {
        ...
        private void InitTitleHtml(Dictionary<int, Dictionary<string, string>> dic)
        {
            ...
            sb.AppendFormat("<img src=\"{0}\" />", csPic1.Replace("_2.", "_6."));
           ...
           // sb.Append("</a>");
            ...
            sbBottom.AppendFormat("<a href=\"http://price.m.yiche.com/zuidijia/nc{0}/?leads_source=H001013\" class=\"btu\" data-action=\"popup-share\">询价</a>", carEntity1.Id);
            sb.Append("</div>");
            sbBottom.Append("</div>");
            ...
            sb.Append("<a href=\"###\">");
            sbBottom.Append("<a href=\"###\">");
            sb.AppendFormat("<img src=\"{0}\" />", csPic2.Replace("_2.", "_6."));
            ...
            sbBottom.AppendFormat("<a href=\"http://price.m.yiche.com/zuidijia/nc{0}/?leads_source=H001013\" class=\"btu\" data-action=\"popup-share\">询价</a>", carEntity2.Id);
            sb.Append("</div>");
            sbBottom.Append("</div>");
            sb.Append("</div>");
            sbBottom.Append("</div>");
