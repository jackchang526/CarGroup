    ...
    <div class="container advanced-selectcar-section" id="box">
        <div class="line-box tiaojian_allbox" id="main_box">
            ...
            <div class="tiaojianlistbox">
                ...
                <dl>
                    ...
                    <dd>
                        <ul class="tj_list">
                            ...
                            <li>
                                <label>
                                    <input type="checkbox" id="more_277" />化油器
                                </label>
                            </li>
                        </ul>
                    </dd>
                ...
                <dl>
                    ...
                    <dd>
                        <ul class="tj_list">
                            <li>
                                <label>
                                    <input type="checkbox" id="more_109" />直列
                                </label>
                            </li>
                            <li>
                                <label>
                            ...
                            <li>
                                <label>
                                    <input type="checkbox" id="more_113" />水平对置
                                </label>
                            </li>
                            <li>
                                <label>
                                    <input type="checkbox" id="more_113" />转子
                                </label>
                            </li>
                        </ul>
                    </dd>
                ...
                <dl>
                    ...
                    <dd>
                        <ul class="tj_list">
                            ...
                            <li>
                                <label>
                                    <input type="checkbox" id="more_121" />8缸以上
                                </label>
                            </li>
                        </ul>
                    </dd>
                ...
                <dl>
                    ...
                    <dd>
                        <ul class="tj_list">
                            ...
                            <li>
                                <label>
                                    <input type="checkbox" id="more_126" />国4</label></li>
                            <li>
                                <label>
                                    <input type="checkbox" id="more_127" />国3
                                </label>
                            </li>
                        </ul>
                    </dd>
                ...
                <dl>
                    ...
                    <dd>
                        <ul class="tj_list">
                            ...
                            <li>
                                <label>
                                    <input type="checkbox" id="more_170" />10</label></li>
                        </ul>
                    </dd>
                </dl>
                <dl>
                    ...
                    <dd>
                        <ul class="tj_list">
                            <li>
                                <label>
                                    <input type="checkbox" id="more_164" />92</label></li>
                            <li>
                                <label>
                                    <input type="checkbox" id="more_165" />95</label></li>
                            <li>
                                <label>
                                    <input type="checkbox" id="more_166" />98</label></li>
                            <li>
                                <label>
                                    <input type="checkbox" id="more_167" />柴油</label></li>
                        </ul>
                    </dd>
                </dl>
                ...
                <dl>
                    ...
                    <dd>
                        <ul class="tj_list">
                            <li>
                                <label>
                                    <input type="checkbox" id="more_131" />扭力梁式非独立悬架
                                </label>
                            </li>
                            <li>
                                <label>
                                    <input type="checkbox" id="more_132" />拖曳臂式半独立悬架
                                </label>
                            </li>
                            <li>
                                <label>
                                    <input type="checkbox" id="more_133" />双叉臂式独立悬架
                                </label>
                            </li>
                            <li>
                                <label>
                                    <input type="checkbox" id="more_134" />多连杆式独立悬架
                                </label>
                            </li>
                            <li>
                                <label>
                                    <input type="checkbox" id="more_135" />麦弗逊独立悬架
                                </label>
                            </li>
                        </ul>
                    </dd>
                ...
                <dl>
                    ...
                    <dd>
                        <ul class="tj_list">
                            <li>
                                <label>
                                    <input type="checkbox" id="more_131" />鼓式
                                </label>
                            </li>
                            <li>
                                <label>
                                    <input type="checkbox" id="more_132" />盘式
                                </label>
                            </li>
                            <li>
                                <label>
                                    <input type="checkbox" id="more_133" />通风盘
                                </label>
                            </li>
                            <li>
                                <label>
                                    <input type="checkbox" id="more_134" />碳纤维陶瓷
                                </label>
                            </li>
                        </ul>
                    </dd>
                ...
                <dl>
                    ...
                    <dd>
                        <ul class="tj_list">
                            <li>
                                <label>
                                    <input type="checkbox" id="more_131" />手拉式
                                </label>
                            </li>
                            <li>
                                <label>
                                    <input type="checkbox" id="more_132" />脚踩式
                                </label>
                            </li>
                            <li>
                                <label>
                                    <input type="checkbox" id="more_133" />电子式
                                </label>
                            </li>
                        </ul>
                    </dd>
                ...
                <dl>
                    ...
                    <dd>
                        <ul class="tj_list">
                            <li>
                                <label>
                                    <input type="checkbox" id="more_139" />前桥
                                </label>
                            </li>
                            <li>
                                <label>
                                    <input type="checkbox" id="more_140" />后桥
                                </label>
                            </li>
                            <li>
                                <label>
                                    <input type="checkbox" id="more_138" />中央
                                </label>
                            </li>
                        </ul>
                    </dd>
                ...
                <dl>
                    ...
                    <dd>
                        <ul class="tj_list">
                            <li>
                                <label>
                                    <input type="checkbox" id="more_141" />前轮驱动
                                </label>
                            </li>
                            <li>
                                <label>
                                    <input type="checkbox" id="more_142" />后轮驱动
                                </label>
                            </li>
                            <li>
                                <label>
                                    <input type="checkbox" id="more_143" />全时四驱
                                </label>
                            </li>
                            <li>
                                <label>
                                    <input type="checkbox" id="more_144" />分时四驱
                                </label>
                            </li>
                            <li>
                                <label>
                                    <input type="checkbox" id="more_145" />适时四驱</label></li>
                        </ul>
                    </dd>
                </dl>
                ...
                <dl>
                    ...
                    <dd>
                        <ul class="tj_list">
                            <li>
                                <label>
                                    <input type="checkbox" id="more_177" />防抱死制动(ABS)
                                </label>
                            </li>
                            <li>
                                <label>
                                    <input type="checkbox" id="more_178" />制动力分配(EBD/CBC等)
                                </label>
                            </li>
                            <li>
                                <label>
                                    <input type="checkbox" id="more_179" />制动辅助(BA/EBA/BAS等)
                                </label>
                            </li>
                            <li>
                                <label>
                                    <input type="checkbox" id="more_180" />牵引力控制(ARS/TCS/TRC等)
                                </label>
                            </li>
                            <li>
                                <label>
                                    <input type="checkbox" id="more_181" />车身稳定控制(ESP/DSC/VSC等) 
                                </label>
                            </li>
                        </ul>
                    </dd>
                ...
                <dl>
                    ...
                    <dd>
                        <ul class="tj_list">
                            ...
                            <li>
                                <label>
                                    <input type="checkbox" id="more_176" />安全带气囊</label></li>
                            <li>
                                <label>
                                    <input type="checkbox" id="more_176" />后排中央气囊</label></li>
                        </ul>
                    </dd>
                </dl>
                <dl>
                    ...
                    <dd>
                        <ul class="tj_list">
                            <li>
                                <label>
                                    <input type="checkbox" id="more_171" />胎压监测</label></li>
                            <li>
                                <label>
                                    <input type="checkbox" id="more_172" />零压续行轮胎</label></li>
                            <li>
                                <label>
                                    <input type="checkbox" id="more_173" />儿童座椅接口</label></li>
                        </ul>
                    </dd>
                </dl>
                ...
                <dl>
                    ...
                    <dd>
                        <ul class="tj_list">
                            ...
                            <li>
                                <label>
                                    <input type="checkbox" id="more_187" />夜视系统
                                </label>
                            </li>
                            <li>
                                <label>
                                    <input type="checkbox" id="more_187" />
                                    陡坡缓降
                                </label>
                            </li>
                            <li>
                ...
                <dl>
                    ...
                    <dd>
                        <ul class="tj_list">
                            <li>
                                <label>
                                    <input type="checkbox" id="more_182" />自动泊车
                                </label>
                            </li>
                            <li>
                                <label>
                                    <input type="checkbox" id="more_183" />自动驻车
                                </label>
                            </li>
                            <li>
                                <label>
                                    <input type="checkbox" id="more_184" />遥控泊车
                                </label>
                            </li>
                            <li>
                                <label>
                                    <input type="checkbox" id="more_185" />上坡辅助
                                </label>
                            </li>
                            <li>
                                <label>
                                    <input type="checkbox" id="more_186" />车前倒车雷达
                                </label>
                            </li>
                            <li>
                                <label>
                                    <input type="checkbox" id="more_187" />车后倒车雷达
                                </label>
                            </li>
                            <li>
                                <label>
                                    <input type="checkbox" id="more_187" />倒车影像
                                </label>
                            </li>
                            <li>
                                <label>
                                    <input type="checkbox" id="more_187" />360全景影像
                                </label>
                            </li>
                        </ul>
                    </dd>
                ...
                <dl>
                    ...
                    <dd>
                        <ul class="tj_list">
                            <li>
                                <label>
                                    <input type="checkbox" id="more_204" />卤素</label></li>
                            <li>
                                <label>
                                    <input type="checkbox" id="more_205" />氙灯</label></li>
                            <li>
                                <label>
                                    <input type="checkbox" id="more_206" />LED</label></li>
                            <li>
                                <label>
                                    <input type="checkbox" id="more_207" />激光</label></li>
                        </ul>
                    </dd>
                </dl>
                <dl>
                    ...
                    <dd>
                        <ul class="tj_list">
                            <li>
                                <label>
                                    <input type="checkbox" id="more_204" />自动开闭</label></li>
                            <li>
                                <label>
                                    <input type="checkbox" id="more_205" />自动远近光</label></li>
                            <li>
                                <label>
                                    <input type="checkbox" id="more_206" />自动转向</label></li>
                            <li>
                                <label>
                                    <input type="checkbox" id="more_207" />转向辅助灯</label></li>
                        </ul>
                    </dd>
                </dl>
                <dl>
                ...
                <dl>
                    ...
                    <dd>
                        <ul class="tj_list">
                            <li>
                                <label>
                                    <input type="checkbox" id="more_204" />隐私玻璃</label></li>
                            <li>
                                <label>
                                    <input type="checkbox" id="more_205" />后排侧遮阳帘</label></li>
                            <li>
                                <label>
                                    <input type="checkbox" id="more_206" />后遮阳帘</label></li>
                        </ul>
                    </dd>
                </dl>
                <dl>
                    ...
                    <dd>
                        <ul class="tj_list">
                            <li>
                                <label>
                                    <input type="checkbox" id="more_215" />前感应雨刷
                                </label>
                            </li>
                            <li>
                                <label>
                                    <input type="checkbox" id="more_216" />后感应雨刷
                                </label>
                            </li>
                            <li>
                                <label>
                                    <input type="checkbox" id="more_217" />后雨刷
                                </label>
                            </li>
                        </ul>
                    </dd>
                ...
                <dl>
                    ...
                    <dd>
                        <ul class="tj_list">
                            <li>
                                <label>
                                    <input type="checkbox" id="more_215" />运动外观套件
                                </label>
                            </li>
                            <li>
                                <label>
                                    <input type="checkbox" id="more_216" />扰流板
                                </label>
                            </li>
                            <li>
                                <label>
                                    <input type="checkbox" id="more_217" />车顶行李架
                                </label>
                            </li>
                        </ul>
                    </dd>
                ...
                <dl>
                    ...
                    <dd>
                        <ul class="tj_list">
                            <li>
                                <label>
                                    <input type="radio" name="roof" id="more_2" />无钥匙进入</label></li>
                            <li>
                                <label>
                                    <input type="radio" name="roof" id="more_219" />无钥匙启动</label></li>
                        </ul>
                    </dd>
                </dl>
                <dl>
                    ...
                    <dd>
                        <ul class="tj_list">
                            <li>
                                <label>
                                    <input type="radio" name="roof" id="more_2" />电动侧滑门</label></li>
                            <li>
                                <label>
                                    <input type="radio" name="roof" id="more_219" />电吸门</label></li>
                        </ul>
                    </dd>
                </dl>
                <dl>
                    ...
                    <dd>
                        <ul class="tj_list">
                            <li>
                                <label>
                                    <input type="radio" name="roof" id="more_2" />电动开合</label></li>
                            <li>
                                <label>
                                    <input type="radio" name="roof" id="more_219" />感应开合</label></li>
                        </ul>
                    </dd>
                </dl>
                ...
                <dl>
                    ...
                    <dd>
                        <ul class="tj_list">
                            <li>
                                <label>
                                    <input type="checkbox" id="more_233" />车内氛围灯</label></li>
                            <li>
                                <label>
                                    <input type="checkbox" id="more_234" />遮阳板化妆镜</label></li>
                            <li>
                                <label>
                                    <input type="checkbox" id="more_235" />香氛系统</label></li>
                            <li>
                                <label>
                                    <input type="checkbox" id="more_236" />车载冰箱</label></li>
                            <li>
                                <label>
                                    <input type="checkbox" id="more_237" />空气净化</label></li>
                        </ul>
                    </dd>
                </dl>
                <dl>
                    ...
                    <dd>
                        <ul class="tj_list">
                            ...
                            <li>
                                <label>
                                    <input type="checkbox" id="more_232" />上下调整
                                </label>
                            </li>
                            <li>
                                <label>
                                    <input type="checkbox" id="more_231" />左右调整
                                </label>
                            </li>
                            <li>
                                <label>
                                    <input type="checkbox" id="more_232" />电动上下左右调整
                                </label>
                            </li>
                            <li>
                                <label>
                                    <input type="checkbox" id="more_231" />记忆
                                </label>
                            </li>
                            <li>
                                <label>
                                    <input type="checkbox" id="more_232" />方向盘加热
                                </label>
                            </li>
                            <li>
                                <label>
                                    <input type="checkbox" id="more_232" />换挡拨片
                                </label>
                            </li>
                        </ul>
                    </dd>
                ...
                <dl>
                    ...
                    <dd>
                        <ul class="tj_list">
                            <li>
                                <label>
                                    <input type="checkbox" id="more_233" />手动空调</label></li>
                            <li>
                                <label>
                                    <input type="checkbox" id="more_234" />自动空调</label></li>
                            <li>
                                <label>
                                    <input type="checkbox" id="more_235" />双温区自动空调</label></li>
                        </ul>
                    </dd>
                </dl>
                <dl>
                ...
                <dl>
                    ...
                    <dd>
                        <ul class="tj_list">
                            <li>
                                <label>
                                    <input type="checkbox" id="more_233" />塑料</label></li>
                            <li>
                                <label>
                                    <input type="checkbox" id="more_234" />皮质</label></li>
                            <li>
                                <label>
                                    <input type="checkbox" id="more_235" />木质</label></li>
                             <li>
                                <label>
                                    <input type="checkbox" id="more_235" />金属</label></li>
                              <li>
                                <label>
                                    <input type="checkbox" id="more_235" />碳纤维</label></li>
                        </ul>
                    </dd>
                </dl>
                <h6 id="params-innerconfig">座椅配置</h6>
                <dl>
                    <dt>座椅材质</dt>
                    <dd>
                        <ul class="tj_list">
                            <li>
                                <label>
                                    <input type="checkbox" id="more_233" />织物</label></li>
                            <li>
                                <label>
                                    <input type="checkbox" id="more_234" />皮质</label></li>
                            <li>
                                <label>
                                    <input type="checkbox" id="more_235" />织物皮质混合</label></li>
                        </ul>
                    </dd>
                </dl>
                <dl>
                    ...
                    <dd>
                        <ul class="tj_list">
                            <li>
                                <label>
                                    <input type="checkbox" id="more_233" />电动调节</label></li>
                            <li>
                                <label>
                                    <input type="checkbox" id="more_234" />记忆</label></li>
                            <li>
                                <label>
                                    <input type="checkbox" id="more_235" />靠背</label></li>
                             <li>
                                <label>
                                    <input type="checkbox" id="more_233" />高低</label></li>
                            <li>
                                <label>
                                    <input type="checkbox" id="more_234" />腰部</label></li>
                            <li>
                                <label>
                                    <input type="checkbox" id="more_235" />肩部</label></li>
                             <li>
                                <label>
                                    <input type="checkbox" id="more_233" />腿托</label></li>
                        </ul>
                    </dd>
                </dl>
                <dl>
                ...
                <dl>
                    ...
                    <dd>
                        <ul class="tj_list">
                            <li>
                                <label>
                                    <input type="checkbox" id="more_233" />全部放倒</label></li>
                            <li>
                                <label>
                                    <input type="checkbox" id="more_234" />按比例放倒</label></li>
                        </ul>
                    </dd>
                </dl>
                <dl>
                    ...
                    <dd>
                        <ul class="tj_list">
                            <li>
                                <label>
                                    <input type="checkbox" id="more_233" />加热</label></li>
                            <li>
                                <label>
                                    <input type="checkbox" id="more_234" />通风</label></li>
                             <li>
                                <label>
                                    <input type="checkbox" id="more_234" />按摩</label></li>
                        </ul>
                    </dd>
                </dl>
                <dl>
                ...
                <h6 id="params-innerconfig">娱乐通讯</h6>
                <dl id="anchorTarget">
                    <dt>驾驶辅助</dt>
                    <dd>
                        <ul class="tj_list">
                            <li>
                                <label>
                                    <input type="checkbox" id="more_240" />全液晶仪表盘</label></li>
                            <li>
                                <label>
                                    <input type="checkbox" id="more_241" />中控液晶屏</label></li>
                            <li>
                                <label>
                                    <input type="checkbox" id="more_242" />gps</label></li>
                            <li>
                                <label>
                                    <input type="checkbox" id="more_243" />行车电脑</label></li>
                            <li>
                                <label>
                                    <input type="checkbox" id="more_244" />hud平视</label></li>
                            <li>
                                <label>
                                    <input type="checkbox" id="more_244" />智能互联定位</label></li>
                        </ul>
                    </dd>
                </dl>
                <dl>
                    ...
                    <dd>
                        <ul class="tj_list">
                            <li>
                                <label>
                                    <input type="checkbox" id="more_245" />carplay</label></li>
                            <li>
                                <label>
                                    <input type="checkbox" id="more_246" />android</label></li>
                            <li>
                                <label>
                                    <input type="checkbox" id="more_247" />手机无线充电</label></li>
                            <li>
                                <label>
                                    <input type="checkbox" id="more_248" />蓝牙</label></li>
                            <li>
                                <label>
                                    <input type="checkbox" id="more_249" />wifi</label></li>
                            <li>
                                <label>
                                    <input type="checkbox" id="more_249" />220v电源</label></li>
                        </ul>
                    </dd>
                </dl>
            </div>
            <div style="position: fixed; left: 200px;" id="left-nav" class="left-nav left-nav-duibi">
                ...
                <ul>
                    ...
                    <li class=""><a href="javascript:;" data-target="">座椅配置</a></li>
                    <li class=""><a href="javascript:;" data-target="params-innerconfig">娱乐通讯</a></li>
                </ul>
