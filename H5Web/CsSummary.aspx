<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CsSummary.aspx.cs" Inherits="H5Web.CsSummary" ContentType="text/html" %>
...
<body>
    ...
    <script type="text/javascript">
        ...
        if(typeof (share_dealerInfo) != "undefined")
        {
            ...
            pageShareContent.link=pageShareContent.link.replace("?","")+"dealer/"+dealerid+"/?";
        }
        if(typeof (share_brokerInfo) != "undefined")
        {
            ...
            pageShareContent.link=pageShareContent.link.replace("?","")+"broker/"+brokerid+"/?";
        }
    </script>
    <script src="http://res.wx.qq.com/open/js/jweixin-1.0.0.js"></script>
    <script type="text/javascript" src="http://image.bitautoimg.com/carchannel/h5/js/H5Stat.js?20150910"></script>
