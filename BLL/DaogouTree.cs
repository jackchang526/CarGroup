...
{
	public class DaogouTree : NewsTreeData
    {
        private string _TagType = "daogou";
		public DaogouTree()
		{
			base.carNewsType = Common.Enum.CarNewsType.daogou;
		}
        /// <summary>
        /// 构建树形结构的XML文档
        /// </summary>
        ...
        {
            string filePath = HttpContext.Current.Server.MapPath("/include/09gq/09gq_kan/09gq_daogou/00001/09gq_kc_dg_jdt_Manual.shtml");
        ...
        {
            string filePath = HttpContext.Current.Server.MapPath("/include/09gq/09gq_kan/09gq_daogou/00001/09gq_kc_dg_dgxw_Auto.shtml");
            if (!File.Exists(filePath))
            {
                return "";
            }
