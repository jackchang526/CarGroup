...
namespace H5Web.Test.Broker
{
	public partial class TestPage : H5PageBase
	{
		...
		protected string BrokerInfoHtml = string.Empty;
		#endregion
		...
		/// 初始化经纪人信息
		/// </summary>
		private void IntiBrokerInfo()
		{
			string filrPath = System.Web.HttpContext.Current.Server.MapPath("~") + "\\test\\Broker\\Broker.txt";
			if (File.Exists(filrPath))
			{
				BrokerInfoHtml = File.ReadAllText(filrPath, Encoding.UTF8);
			}
		}
