<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DealerCarReference.aspx.cs" Inherits="H5Web.V2.module.dealer.DealerCarReference" %>
...
<body>
	<div class="context_scroll" data-name="dealercarreference">
		<div class="context_scroll_box">
			<script type="text/javascript">
				//经销商接口：经销商地图
				document.write(unescape("%3Cscript src='/handlers/GetDateAsync.ashx?service=dealer&method=dealercarreference&csid=<%= SerialId %>&dealerid=<%= Dealerid %>' type='text/javascript'%3E%3C/script%3E"));
			</script>
			<%--</div>--%>
			<div class="h60"></div>
