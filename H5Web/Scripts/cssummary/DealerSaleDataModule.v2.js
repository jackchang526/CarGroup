...
function getDelarSaleCarPrice() {
    ...
    $.get("/handlers/GetDataAsynV4.ashx?service=dealersale&method=dealersalecarprice&dealerpersonid=" + Config.dealerpersonid + "&csid=" + Config.serialId + "&", function(data) {
        if (checkData(data)) {
...
function getDelarSaleCarNews() {
    ...
    $.get("/handlers/GetDataAsynV4.ashx?service=dealersale&method=dealersalenews&dealerpersonid=" + Config.dealerpersonid + "&csid=" + Config.serialId + "&", function(data) {
        if (checkData(data)) {
...
function getDelarSaleSerial() {
    ...
    $.get("/handlers/GetDataAsynV4.ashx?service=dealersale&method=dealersaleserial&dealerpersonid=" + Config.dealerpersonid + "&csid=" + Config.serialId + "&", function(data) {
        if (checkData(data)) {
...
function getDelarSaleShop() {
    ...
    $.get("/handlers/GetDataAsynV4.ashx?service=dealersale&method=dealersaleshop&dealerpersonid=" + Config.dealerpersonid + "&csid=" + Config.serialId + "&", function(data) {
        if (checkData(data)) {
