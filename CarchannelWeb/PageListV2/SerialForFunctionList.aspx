<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SerialForFunctionList.aspx.cs"
    Inherits="BitAuto.CarChannel.CarchannelWeb.PageListV2.SerialForFunctionList" %>
            ...
            <div class="container">
                <div class="col-auto left secondary">
                    <ul class="list">
                        ...
                        <li id="accordUse" class="active"><a href="/functionlist.html<%=(wt=="2345nyif"?"?WT.mc_id=2345nyif":"") %>">按用途</a></li>
                    </ul>
                </div>
            </div>
        </nav>
        ...
        <div style="width: 100%; height: 45px; overflow: hidden;">
            <div id="theid">
                <ul class="list list-gapline sm a-z type-1">
                    <li class=" "><a href="#yy">越野</a></li>
                    <li class=" "><a href="#ss">时尚</a></li>
                    <li class=" "><a href="#jy">家用</a></li>
                    <li class=" "><a href="#db">代步</a></li>
                    <li class=" "><a href="#xx">休闲</a></li>
                    <li class=" "><a href="#yd">运动</a></li>
                    <li class=" "><a href="#sw">商务</a></li>
                    <li class=" "><a href="#cr">cross</a></li>
